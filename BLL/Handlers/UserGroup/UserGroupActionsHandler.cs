...
public interface IUserGroupActionsHandler
{
    ...
    Task<IDtoResultBase> UserGroupInviteRequestCreate(
        UserGroupActionInviteRequestCreateDto data,
        CancellationToken cancellationToken = default
    );

    Task<IDtoResultBase> UserGroupInviteRequestUpdate(
        UserGroupActionInviteRequestUpdateDto data,
        CancellationToken cancellationToken = default
    );

    Task<IDtoResultBase> UserGroupInviteRequestRead(
        UserGroupActionInviteRequestReadDto data,
        CancellationToken cancellationToken = default
    );

    Task<IDtoResultBase> UserGroupInviteRequestReceiverReadCollection(
        UserGroupActionInviteRequestReceiverReadCollectionDto data,
        CancellationToken cancellationToken = default
    );

    Task<IDtoResultBase> UserGroupInviteRequestSenderReadCollection(
        UserGroupActionInviteRequestSenderReadCollectionDto data,
        CancellationToken cancellationToken = default
    );
...
public class UserGroupActionsHandler : HandlerBase, IUserGroupActionsHandler
{
    ...
    )
    {
        ...
        try
        {
            ...
            return _mapper.Map<UserGroupActionTransferRequestCreateResultDto>(userGroupTransferRequest);
        }
        catch (Exception)
        {
    ...
    )
    {
        ...
        try
        {
            ...
            return _mapper.Map<UserGroupActionTransferRequestReadResultDto>(userGroupTransferRequest);
        }
        catch (Exception)
        {
            await _appDbContextAction.RollbackTransactionAsync();
    ...
    )
    {
        ...
        try
        {
            ...
            return new UserGroupActionTransferRequestReadCollectionResultDto
            {
    ...
    )
    {
        ...
        try
        {
            ...
            return _mapper.Map<UserGroupActionInviteRequestCreateResultDto>(userGroupInviteRequest);
        }
        catch (Exception)
        {
            await _appDbContextAction.RollbackTransactionAsync();
    ...
    )
    {
        ...
        try
        {
            ...
            return _mapper.Map<UserGroupActionInviteRequestReadResultDto>(userGroupInviteRequest);
        }
        catch (Exception)
        {
            await _appDbContextAction.RollbackTransactionAsync();
    ...
    )
    {
        ...
        try
        {
            ...
            return new UserGroupActionInviteRequestReadCollectionResultDto
            {
