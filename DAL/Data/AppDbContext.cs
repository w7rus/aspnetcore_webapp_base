...
namespace DAL.Data
{
    public sealed class AppDbContext : DbContext
    {
        ...
        private static AppDbContextSeedLists Seed()
        {
            ...
            var permissions = new List<Permission>
            {
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_any_a_create_o_permissionvalue,
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_any_a_read_o_permissionvalue,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual,
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_any_a_update_o_permissionvalue,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_any_a_delete_o_permissionvalue,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_group_a_create_o_usergroup,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_group_a_read_o_usergroup,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_group_a_update_o_usergroup,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_group_a_delete_o_usergroup,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_user_a_read_o_user,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_user_a_update_o_user,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_user_a_delete_o_user,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_userprofile_a_read_o_userprofile,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_userprofile_a_update_o_userprofile,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_file_a_create_o_file,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_file_a_create_o_file_o_agerating_l_automapper,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_file_a_read_o_file,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_file_a_update_o_file,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_file_a_update_o_file_o_agerating_l_automapper,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
                ...
                new()
                {
                    ...
                    Alias = Consts.PermissionAlias.g_file_a_delete_o_file,
                    Type = PermissionType.Value,
                    CompareMode = PermissionCompareMode.GreaterOrEqual
                },
                new()
            ...
            var userGroups = new List<UserGroup>
            {
                new()
                {
                    ...
                    Alias = "Root",
                    Description =
                        "User group with root like permission set. Also used to store system wise permission values",
                    IsSystem = true,
                    Priority = Consts.RootUserGroupPriority
                },
                new()
                {
                    ...
                    IsSystem = true,
                    Priority = Consts.BannedUserGroupPriority
                },
                new()
                {
                    ...
                    IsSystem = true,
                    Priority = Consts.MemberUserGroupPriority
                },
                new()
                {
                    ...
                    IsSystem = true,
                    Priority = Consts.GuestUserGroupPriority
                }
            };
            ...
            var rootUserGroupPermissionValues = new List<PermissionValue>()
            {
                ...
                new()
                {
                    ...
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_create_o_permissionvalue && _.Type == PermissionType.Value).Id,
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_create_o_permissionvalue && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_create_o_permissionvalue && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_read_o_permissionvalue && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_read_o_permissionvalue && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_read_o_permissionvalue && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_update_o_permissionvalue && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_update_o_permissionvalue && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_update_o_permissionvalue && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_delete_o_permissionvalue && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_delete_o_permissionvalue && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_any_a_delete_o_permissionvalue && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_create_o_usergroup && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_create_o_usergroup && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_read_o_usergroup && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_read_o_usergroup && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_read_o_usergroup && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_update_o_usergroup && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_update_o_usergroup && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_update_o_usergroup && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_delete_o_usergroup && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_delete_o_usergroup && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_group_a_delete_o_usergroup && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_read_o_user && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_read_o_user && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_read_o_user && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_update_o_user && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_update_o_user && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_update_o_user && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_delete_o_user && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_delete_o_user && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_user_a_delete_o_user && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_read_o_userprofile && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_read_o_userprofile && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_read_o_userprofile && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_update_o_userprofile && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_update_o_userprofile && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_update_o_userprofile && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_userprofile_a_update_o_userprofile_o_avatar_l_maxfilesize && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_create_o_file && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_create_o_file && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_create_o_file && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_create_o_file_o_agerating_l_automapper && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_create_o_file_o_agerating_l_automapper && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_create_o_file_o_agerating_l_automapper && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_read_o_file && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_read_o_file && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_read_o_file && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_update_o_file && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_update_o_file && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_update_o_file && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_update_o_file_o_agerating_l_automapper && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_update_o_file_o_agerating_l_automapper && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_update_o_file_o_agerating_l_automapper && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
                ...
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_delete_o_file && _.Type == PermissionType.Value).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_delete_o_file && _.Type == PermissionType.ValueNeededOwner).Id,
                    EntityId = rootUserGroup.Id,
                },
                new()
                {
                    ...
                    Value = BitConverter.GetBytes(rootUserGroupPower),
                    PermissionId = permissions.Single(_ => _.Alias == Consts.PermissionAlias.g_file_a_delete_o_file && _.Type == PermissionType.ValueNeededOthers).Id,
                    EntityId = rootUserGroup.Id,
                },
            ...
            userToUserGroupMappings.AddRange(new []
            {
                new UserToUserGroupMapping
                {
                    Id = new Guid("d49b34c2-7970-436a-9c61-0a63466889df"),
                    EntityLeftId = userRoot.Id,
                    EntityRightId = rootUserGroup.Id,
                }
            });
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            {
                // _.HasIndex(__ => __.FullAlias).IsUnique();

                _.HasIndex(__ => new {__.Alias, __.Type}).IsUnique();
            ...
            {
                _.HasIndex(__ => __.Email).IsUnique().HasFilter(null);
